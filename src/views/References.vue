<template>
  <div class="business-list-view">
    ...
    <div class="form">
      ...
      <input v-model="newBusiness.code" placeholder="Код" />
      <input v-model="newBusiness.type" placeholder="Тип" />
      <input v-model="newBusiness.businessDecription" placeholder="Описание бизнеса" />
      <input v-model="newBusiness.nameKk" placeholder="Название (Каз)" />
      <input v-model="newBusiness.nameRu" placeholder="Название (Рус)" />
      <input v-model="newBusiness.descriptionKk" placeholder="Описание (Каз)" />
      <input v-model="newBusiness.descriptionRu" placeholder="Описание (Рус)" />
      ...
      <tbody>
        <tr v-for="business in businessList" :key="business.id">
          ...
          <td v-if="!business.isEditing">
            <button @click="editBusiness(business)">Редактировать</button>
          </td>
          <td v-else>
            <button @click="updateBusiness(business)">Сохранить</button>
          </td>
        </tr>
      </tbody>
    </table>
